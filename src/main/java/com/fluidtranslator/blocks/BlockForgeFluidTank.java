...
public class BlockForgeFluidTank extends BlockContainer {
    public BlockForgeFluidTank() {
        ...
        setBlockTextureName(FluidTranslator.MODID + ":fluid_tank_block");
        setHardness(2.0F);
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z,
        ...
        if (!world.isRemote) {
            player.openGui(FluidTranslator.instance, GuiIds.SIMPLE_FLUID_TANK.ordinal, world, x, y, z); // 0 = GUI ID
        }
        return true;
    }
}
